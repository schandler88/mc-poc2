...
class MVTWorker {
    ...
    async _requestDataframe (x, y, z, url, layerID, metadata) {
        ...
        const dataframe = await this.urlToDataframeTransformer(response, x, y, z, layerID, metadata, url);
        return dataframe;
    }

    async urlToDataframeTransformer (response, x, y, z, layerID, metadata, url) {
...
/******/ });
//# sourceMappingURL=e41aab3094be42b28409.worker.js.map