...
var Switch = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        if (this.label) {
            return (h("div", { class: 'as-switch' }, h("div", { class: 'as-switch__element' }, this._renderSwitch()), h("label", { class: 'as-switch__label as-body' }, this.label)));
        }
    ...
    class_1.prototype._renderSwitch = function () {
        return [
            ...
            h("svg", { class: 'as-switch__thumb', width: '10', height: '8', xmlns: 'http://www.w3.org/2000/svg' }, h("path", { fill: 'currentColor',
