...
var LegendSizeBinsPoint = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        var classes = (_a = {
            ...
            _a["as-legend-size-category-line--" + this.orientation] = true,
            _a);
        this.maxSize = this.data.slice().sort(function (first, second) { return second.width - first.width; })[0].width;
    ...
    class_1.prototype.renderStep = function (data) {
        ...
        var lineWidth = Math.max(MIN_WIDTH, this.maxSize * this.factor);
        var style = Object.assign({ height: data.width + "px", width: lineWidth + "px" }, strokeStyle);
        var wrapperStyle = {};
        ...
        return (h("div", { class: 'as-legend-size-category-line--step' }, h("div", { style: wrapperStyle, class: 'as-legend-size-category-line--line-wrapper' }, h("div", { class: 'as-legend-size-category-line--line', style: style })), h("span", { class: 'as-legend-size-category-line--label' }, data.label)));
    };
