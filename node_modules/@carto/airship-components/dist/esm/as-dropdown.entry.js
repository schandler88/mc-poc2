...
const Dropdown = class {
    ...
    render() {
        ...
        return (h("div", { class: controlClasses }, h("button", { class: 'as-dropdown__control as-body', "aria-haspopup": 'true', "aria-expanded": this.isOpen, onClick: (e) => { e.stopPropagation(); this._toggleList(); } }, this.selectedOptionObject && this.selectedOptionObject.text
    ...
    _renderOptions(options) {
        return options.map((option) => {
            ...
            return (h("li", { class: 'as-dropdown__list-item', "data-value": option.value }, h("button", { class: buttonClasses, onClick: (e) => { e.stopPropagation(); this._select(option); } }, option.text || option.value)));
        });
    }
    _isSelected(option) {
