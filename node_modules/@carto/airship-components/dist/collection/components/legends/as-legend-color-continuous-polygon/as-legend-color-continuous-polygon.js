...
export class LegendColorContinuousPolygon {
    ...
    static get originalStyleUrls() { return {
        "$": ["./as-legend-color-continuous-polygon.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["as-legend-color-continuous-polygon.css"]
    }; }
