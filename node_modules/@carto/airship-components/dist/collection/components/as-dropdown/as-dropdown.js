...
export class Dropdown {
    ...
    static get properties() { return {
        "options": {
            ...
            "docs": {
                ...
                "text": "Array of options to display in the dropdown"
            },
            "defaultValue": "[]"
        },
        "selectedOption": {
            ...
            "docs": {
                ...
                "text": "Selected option to show in the dropdown"
            },
        ...
        "defaultText": {
            ...
            "docs": {
                ...
                "text": "Default text to show when no option is selected"
            },
        ...
        "showClearButton": {
            ...
            "docs": {
                ...
                "text": "Allow the user to clear selected option"
            },
        ...
        "onClickOutside": {
            ...
            "docs": {
                ...
                "text": "Function called when clicking outside of the dropdown.\nBy default it closes the list."
            },
            "defaultValue": "() => { this._closeList(); }"
        }
    }; }
    ...
    static get events() { return [{
            ...
            "docs": {
                ...
                "text": "Fired when selected option changes or option is cleared"
            },
            "complexType": {
                "original": "string",
                "resolved": "string",
    ...
    static get methods() { return {
        "closeList": {
            ...
            "docs": {
                "text": "Closes the list, useful in case you need to customize {onClickOutside}",
                "tags": [{
                        "name": "memberof",
                        "text": "Dropdown"
                    }]
    ...
    static get watchers() { return [{
            ...
            "methodName": "onClickOutsideChanged"
        }]; }
}
