...
const LegendCategoryPointEntry = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
    ...
    getWidth() {
        ...
        let sizeOffset = borderStyleCounts.borderStyleCounts(this.strokeStyle)
            ? FAKE_BORDER_SIZE * 2
            : 0;
        if (this.marker) {
...
exports.as_legend_category = LegendColorCategory;
exports.as_legend_category_line_entry = LegendCategoryLineEntry;
exports.as_legend_category_point_entry = LegendCategoryPointEntry;
exports.as_legend_category_polygon_entry = LegendColorCategoryPolygonEntry;
